...
Ext.define('TeamDomain.controller.showDataProperty', {
    ...
    onGridpanelSelectionChangeDA: function (model, selected, eOpts) {
        ...
        Ext.getCmp('domainGridPanelA').disable();
        var dataD = null;
        ...
        if (Object.keys(selected).length !== 0) {
            ...
            //console.log("onGridpanelSelectionChangeDA: return");
            Ext.getCmp('domainGridPanelA').enable();
            var store = Ext.getStore('DomainDataStoreA');
            dataD = Ext.apply({target_folder: show_target_folder}, store.data.items[0].data);
            //return;
        }
        ...
        function handleSuccess(response) {
            ...
            if (request_success === false) {
                ...
                requestRefresh();
                var thisSelectionModel = Ext.ComponentQuery.query("#folderPanelA")[0].getSelectionModel();
                thisSelectionModel.deselectAll(true);
...
//                    Ext.getStore('TargetFolderATFi').load();
        ...
        function requestRefresh() {
            sending_cont_location = dataD.cont_location;
            sending_hash_key = dataD.hash_key;
            ...
            requestRefreshData = Ext.apply({event_type: "selected_domain"}, requestRefreshData);
    ...
    onGridpanelSelectionChangeDB: function (model, selected, eOpts) {
        if (DomainLoadingCount === 0) {
            ...
            if (Object.keys(selected).length !== 0) {
                ...
                console.log("onGridpanelSelectionChangeDB: return");
                return;
            }
            var dataD;
            dataD = Ext.apply({target_folder: show_target_folder}, selected[0].data);
    ...
    onTreepanelSelectionChangeA: function (model, selected, eOpts) {
        ...
        var folderPanelName = 'フォルダ -';
        var folderPanelTitle = 'folderPanelA';
        //var listScreen = 'listDspA';
        var listScreen = 'listGridPanelA';
        var iconScreen = '';
        //var thumbnailScreen = 'thumbnailDspA';
        var thumbnailScreen = 'thumbnailGridPanelA';
        ...
        if (Object.keys(selected).length !== 0) {
            ...
            viewFolder.down('#eastSidePanel').loadRecord(selected[0]);
            ...
            /*Ext.getCmp('activeData').getForm().setValues({
                ...
                activeFolderA_text: selected[0].data.text,
                activeFolderA_cont_location: selected[0].data.cont_location,
            ...
            var targetStatus = selected[0].data.folder_writable_status;
            ...
            console.log("onTreepanelSelectionChangeA: return");
            return;
        }
        ...
        if (readChecked === true) {
            ...
            console.log("onTreepanelSelectionChangeA: readChecked: return");
            Ext.getCmp('domainGridPanelA').enable();
            return;
        }
        function handleSuccess(response) {
    ...
    onTreepanelSelectionChangeB: function (model, selected, eOpts) {
        ...
        if (Object.keys(selected).length !== 0) {
            ...
            console.log("onTreepanelSelectionChangeB: return");
            return;
        }
        ...
        if (readChecked === true) {
            ...
            console.log("onTreepanelSelectionChangeB: readChecked: return");
            return;
        }
        function handleSuccess(response) {
            obj = Ext.decode(response.responseText);
...
//                viewFolder.down('#searchGroupFolder').loadRecord(record);
                ...
                Ext.getCmp('activeData').getForm().setValues({
                    ...
                    activeFolderA_original_place: 'file_list'
                });
...
//                    Ext.ComponentQuery.query('#enlargeBtn')[0].hide();
                ...
                if (!record.data.other_readable) {
                    record.data.other_readable = false;
                }
                if (!record.data.other_writable) {
                    record.data.other_writable = false;
                }
...
//                viewFile.down('#searchGroupFile').loadRecord(selected[0]);
                ...
                if (Ext.isEmpty(folderWriteChecked)) {
                    folderWriteChecked = true;
                }
...
//                doCheckFile(folderReadChecked, folderWriteChecked, fileReadChecked, fileWriteChecked, fileOwnershipChecked, fileControllerChecked, fileLockChecked, fileOpenChecked, targetStatus, lcUserId, this_op_id);
            ...
            console.log("onGridpanelSelectionChangeFiA: return");
            return;
        }
    ...
    onGridpanelSelectionChangeFiB: function (model, selected, eOpts) {
        ...
        if (Object.keys(selected).length !== 0) {
            ...
            console.log("onGridpanelSelectionChangeFiB: return");
            return;
        }
    ...
    onGridpanelSelectionChangeFiS: function (model, selected, eOpts) {
        ...
        if (Object.keys(selected).length !== 0) {
            ...
            console.log("onGridpanelSelectionChangeFiS: return");
            return;
        }
        function handleSuccess(response) {
            obj = Ext.decode(response.responseText);
    ...
    onTreeviewSelectionChangeCMDA: function (dataview, selections, eOpts) {
        ...
        if (Object.keys(selections).length !== 0) {
            ...
            console.log("TreeviewSelectionChangeCMDA: return");
            return;
        }
    },
    onTreeviewSelectionChangeCMDB: function (dataview, selections, eOpts) {
        ...
        if (Object.keys(selections).length !== 0) {
            ...
            console.log("TreeviewSelectionChangeCMDB: return");
            return;
        }
    },
    onTreeviewSelectionChangeCMDFiA: function (dataview, selections, eOpts) {
        ...
        if (Object.keys(selections).length !== 0) {
            ...
            if (Ext.isEmpty(originalReadChecked)) {
                originalReadChecked = true;
            }
            if (Ext.isEmpty(originalWriteChecked)) {
                originalWriteChecked = true;
            }
            ...
            console.log("TreeviewSelectionChangeCMDFiA: return");
            return;
        }
    },
    onTreebiewSelectionChangeCMDFiB: function (dataview, selections, eOpts) {
        ...
        if (Object.keys(selections).length !== 0) {
            ...
            console.log("TreeviewSelectionChangeCMDFiB: return");
            return;
        }
    },
    ...
    onDataviewItemClickATB: function (dataview, record, item, index, e, eOpts) {
        ...
        if (record.data.file_type === 'folder') {
            ...
            Ext.getCmp('activeData').getForm().setValues({
                activeFolderA_name: record.data.folder_name,
                activeFolderA_text: record.data.folder_name,
                activeFolderA_hash: record.data.hash_key,
                activeFolderA_readable: record.data.folder_readable_status,
                activeFolderA_writable: record.data.folder_writable_status,
                activeFolderA_original_place: 'file_list'
    ...
    onGridpanelSelect: function (rowmodel, record, index, eOpts) {
        var panelname = eOpts.params.painName;
        var node_data = record.raw;
        if (panelname === "folderPanelA" || panelname === "folderPanelB") {
            var file_name = node_data.folder_name;
            var folder_hash_key = node_data.parent_hash_key;
            select_record = record;
            var vpath = node_data.vpath;
            console.log("FNAME: %s VP: %s", file_name, vpath);
        } else {
            var file_name = node_data.file_name;
            var folder_hash_key = node_data.folder_hash_key;
        }
        var spin_node_hashkey = node_data.spin_node_hashkey;
        var cont_location = node_data.cont_location;
        console.log("FNAME: %s NH: %s", file_name, spin_node_hashkey);
        console.log("FNAME: %s FH: %s", file_name, folder_hash_key);
        console.log("FNAME: %s CL: %s", file_name, cont_location);
        console.log("FNAME: %s PN: %s", file_name, panelname);
        var store = Ext.getStore("SearchOptionStore");
        //console.log("FNAME Store2: ",store);
        //store.selectFile(hash_key);
        //console.log("FNAME Store3: ",store);
        var options = {params: {spin_node_hashkey: spin_node_hashkey}};
        store.load(options);
        //console.log("FNAME Store4: ",store);
        //console.log("FNAME Record: ",record);
        //console.log("FNAME rowmodel: ",rowmodel);
        //console.log("FNAME eOpts: ",eOpts);
    },
// アップロード、アーカイブ、同期機能↓
    onLocalTreepanelSelectionChange: function (model, selected, eOpts) {

        var panelname = eOpts.params.painName;
        var selectedNode = model.getSelection();
        if (panelname === "addAgentTree")
        {
            if (Object.keys(selected).length === 0) {
                return;
            }
            ...
            formX = Ext.apply({params: [selectedNode[0].data.node_path, 1, true]}, formX);

            Ext.getStore('LocalFileDataStore').load({jsonData: formX});
        }
        else if (panelname === "archiveFolderTree")
        {
            if (Object.keys(selected).length === 0) {
                Ext.getCmp("createArchiveFolderBtn").disable();
            }
            else
            {
                Ext.getCmp("createArchiveFolderBtn").enable();
            }
        }
        else if (panelname === "rearchiveFolderList")
        {
            if (Object.keys(selected).length === 0) {
                Ext.getCmp("resetArchiveFolderBtn").disable();
            }
            else
            {
                Ext.getCmp("resetArchiveFolderBtn").enable();
            }
        }
        else if (panelname === "resyncFolderList")
        {
            if (Object.keys(selected).length === 0) {
                Ext.getCmp("resetSyncFolderBtn").disable();
            }
            else
            {
                Ext.getCmp("resetSyncFolderBtn").enable();
            }
        }
        else if (panelname === "syncFolderTree")
        {
            if (Object.keys(selected).length === 0) {
                Ext.getCmp("createSyncFolderBtn").disable();
            }
            else
            {
                Ext.getCmp("createSyncFolderBtn").enable();
            }
        }
        else
        {
            if (Object.keys(selected).length === 0) {
                Ext.getCmp("addAgentDownloadBtn").disable();
            }
            else
            {
...
// フォーカス機能↓
    setFocus: function (me, eOpts)
    {
        var target = eOpts.params.target;
        if (target === "show_folder_name" || target === 'change_file_name')
        {
            Ext.getCmp(target).focus(true, 50);
        }
        else
        {
            Ext.getCmp(target).focus(false, 50);
        }
    },
// フォーカス機能↑
    ...
    init: function (application) {
        this.control({
            ...
            "#folderPanelA": {
                selectionchange: {
                    fn: this.onTreepanelSelectionChangeA,
                    params: {painName: "folderPanelA"}
                },
                select: {
                    fn: this.onGridpanelSelect,
                    params: {painName: "folderPanelA"}
                }
            },
            "#folderPanelB": {
            ...
            "#listGridPanelA": {
                ...
                select: {
                    fn: this.onGridpanelSelect,
                    params: {painName: "listGridPanelA"}
                }
            },
            "#listGridPanelB": {
                ...
                select: {
                    fn: this.onGridpanelSelect,
                    params: {painName: "listGridPanelB"}
                }
            },
...
// アップロード機能↓
            "#addAgentTree": {
                selectionchange: {
                    fn: this.onLocalTreepanelSelectionChange,
                    params: {painName: "addAgentTree"}
                }
            },
// アップロード機能↑
// // ダウンロード機能↓
            "#downloadAgentTree": {
                selectionchange: {
                    fn: this.onLocalTreepanelSelectionChange,
                    params: {painName: "downloadAgentTree"}
                }
            },
// ダウンロード機能↑
// アーカイブ機能↓
            "#archiveFolderTree": {
                selectionchange: {
                    fn: this.onLocalTreepanelSelectionChange,
                    params: {painName: "archiveFolderTree"}
                }
            },
            "#rearchiveFolderList": {
                selectionchange: {
                    fn: this.onLocalTreepanelSelectionChange,
                    params: {painName: "rearchiveFolderList"}
                }
            },
// アーカイブ機能↑
// 同期機能↓
            "#syncFolderTree": {
                selectionchange: {
                    fn: this.onLocalTreepanelSelectionChange,
                    params: {painName: "syncFolderTree"}
                }
            },
            "#resyncFolderList": {
                selectionchange: {
                    fn: this.onLocalTreepanelSelectionChange,
                    params: {painName: "resyncFolderList"}
                }
            },
// 同期機能↑
            "#new_folder":
            ...
            "#show_folder_name":
                    {
                        afterrender:
                                {
                                    fn: this.setFocus,
                                    params: {target: "show_folder_name"}
                                }
                    },
            "#urlLink_pf":
                    {
            ...
            "#change_file_name":
                    {
                        afterrender:
                                {
                                    fn: this.setFocus,
                                    params: {target: "change_file_name"}
                                }
                    }
        });
    }
