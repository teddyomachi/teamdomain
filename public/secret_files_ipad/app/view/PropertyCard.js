...
Ext.define('BoomBoxMobile.view.PropertyCard', {
		...
		function handleSuccess(response) {
			...
			if (request_success === true) {		
				if (MyShowability === false ) {
					...
					var thisHtml = '<div style="height:' + thisHeight + 'px;">このファイルは表示することができません。</iframe></div>';
	...
	onPropertyCardShow: function(component, eOpts) {
		...
		if (MyShowability === false) {	
			...
			htmlString = htmlString + '<img src="'+dispImage+'" style="height:300px;margin-bottom:20px"/>';
			htmlString = htmlString + '</div>';
