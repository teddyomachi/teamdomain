		...
		items: [
			...
			},
			{
				...
				itemTpl: Ext.create('Ext.XTemplate', 
					...
					'	<table width="100%">',
					'		<tr>',
					'			<td rowspan="2" style="width:10%"><img src="{icon_image}" style="width: 50px" /></td>',
					'			<td rowspan="2" style="width:10%">{file_type}</td>',
					'			',
					'			<td rowspan="2" style="width:30%">{file_name:ellipsis(20,true)}</td>',
					'			<td style="width:10%">',
					'				<tpl if="file_type !== \'folder\'">',
					'					ver: {file_version}',
					'				</tpl>',
					'			</td>',
					'			<td style="width:40%">更新: {updated_at:date("Y-m-d H:i:s")}</td>',
					'		</tr>',
					'		<tr>',
					'			<!--<td style="width:30%">{description:ellipsis(20,true)}</td>-->',
					'			<td style="width:10%">',
					'				<tpl if="file_type !== \'folder\'">',
					'					{[this.formSize(values.file_size)]}',
					'				</tpl>',
					'			</td>	',
	...
	onMybutton5Tap1: function(button, e, eOpts) {
		...
		function handleSuccess(response) {
			...
			if (request_success === true) {
				...
				/*
				parentStore.getProxy().setExtraParams(
				{
				"start": 0,
				"page": 1,
				"limit": 25,
				...
				parentStore.load();
				//delete parentStore.proxy.extraParams.param_name;
				parentStore.getProxy().setExtraParams({});
				*/	
